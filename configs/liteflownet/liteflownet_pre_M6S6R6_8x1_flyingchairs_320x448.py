_base_ = [
    '../_base_/models/liteflownet/liteflownet_pre_M6S6R6.py',
...
load_from = 'https://download.openmmlab.com/mmflow/liteflownet/liteflownet_pre_M6S6_8x1_flyingchairs_320x448.pth'  # noqa
